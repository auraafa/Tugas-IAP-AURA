...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#home">Aura Fadhlin</a>
    ...
    <div class="jumbotron" id="home">
      <div class="container">
        <div class="text-center">
          <img src="img/thumbs/7.jpg" class="rounded-circle img-thumbnail">
          <h1 class="display-4">Aura Fadhlin</h1>
          <h3 class="lead">2217020063 | 6-SI.B | Projek IAP</h3>
        </div>
      </div>
    </div>
    ...
    <section class="about" id="about">
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-5">
            <p>Saya merupakan seorang mahasiswa aktif di Universitas Islam Negeri (UIN) Imam Bonjol Padang, jurusan Sistem Informasi, semester 6. Memiliki ketertarikan pada pengembangan sistem berbasis web dan antarmuka pengguna yang ramah. Aura juga aktif dalam berbagai kegiatan akademik dan pengembangan diri di bidang teknologi informasi, dengan fokus utama pada pengembangan aplikasi berbasis website yang dapat memberikan solusi praktis di lingkungan sekitar.</p>
          </div>
          <div class="col-md-5">
            <p>Di luar perkuliahan, Aura memiliki hobi menggambar, mendesain, serta berkarya di bidang seni visual. Aura juga gemar mengeksplorasi hal-hal baru yang berkaitan dengan desain antarmuka (UI/UX) dan sering memanfaatkan waktunya untuk memperdalam pengetahuan tentang teknologi terbaru. Selain itu, Aura aktif mengikuti pelatihan-pelatihan dan seminar teknologi untuk mengembangkan keterampilan profesional, serta senang berbagi ilmu dengan teman-teman sejurusan.(sedikit pencitraan)</p>
          </div>
        </div>
      </div>
    </section>
